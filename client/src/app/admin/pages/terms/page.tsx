  ...
  const handleSubmit = async (formData: PageFormData) => {
    try {
      if (existingPage) {
        ...
        toast.success('Terms & Conditions page updated successfully');
      } else {
        await createPage.mutateAsync({ ...formData, slug: SLUG });
        toast.success('Terms & Conditions page created successfully');
      }
    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Edit the Terms & Conditions page content</p>
        </div>
      </div>
